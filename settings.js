...
//===> UBAH DISINI
global.namaowner = 'Julian' //Ganti Jadi Namamu
global.owner = ['6285795586847','62887433094409','6288289252040'] //Kalo Mau Lebih Tambahin Aja
global.nomerowner = '6285795586847' //Owner Utama Istilahnya
global.namabot = 'Elysia Chan' //Ganti Jadi Nama Botmu
global.packname = 'Elysia Wangy' //Sticker Weem
global.author = 'Julian' //Sticker Weem
global.webme = 'https://github.com/JulianZuikaku' //Ganti Sama Web Mu
global.linkgroup = 'https://chat.whatsapp.com/GStM13Ktxr085ubmy1EMKN' //Ganti Sama Link Gc Mu
global.sessionName = 'session'
global.youtube = '' //Ganti Sama Link Yt Mu
global.github = 'https://github.com/LionSuzune' //Ganti Sama Link Github Mu
global.instagram = 'https://www.instagram.com/lionsuzunee' //Ganti Sama Link Ig mu
...
global.mess = {
admin: '*LU ADMIN? 🤨*',
botAdmin: '*ELYSIA BUKAN ADMIN 😐*',
owner: '*MAAF ANDA BUKAN OWNER ELYSIA😭*',
group: '*KHUSUS GROUP 😏*',
private: '*KHUSUS PRIVATE CHAT*',
bot: '*KHUSUS PENGGUNA NOMER BOT*',
wait: '*ELYSIA SEDANG PROSES😇*',
done: '*DONE NGAB 🤗*',
}
